...
\begin{document}
    ...
    hoe beter)! Oplossingen voor ALLE oefeningen uit het Giancoli-boek kunnen gevonden worden met behulp 
...
\newpage
   ...
   \end{enumerate}
    ...
    \subsection{De elektrische dipool}%TODO elektrische dipool moet aangevuld worden
    WORDT GRAAG GEVRAAGD!
    \newline
    ...
    \section{De wet van Gauss}%TODO wet van gauss hoofdstuk
    22.1-22.3
    ...
    \section{Elektrische stroom en weerstand}%TODO elektrische stroom en weerstand
    25.1-25.6, 25.8-25.9 (+40.7-40.10)


    \section{Gelijkstroomschakelingen}%TODO gelijkstroomschakelingen
    26.2-26.5, 26.7
